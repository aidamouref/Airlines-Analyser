...
<div class='tableauPlaceholder' id='viz1763578607301' style='position: relative'>
    <noscript>
        <a href='#'>
            <img alt='Airlines in Figures'
                 src='https://public.tableau.com/static/images/Ai/Airlines_17198553720830/Historia1/1_rss.png'
                 style='border: none' />
        </a>
    </noscript>
    ...
    <object class='tableauViz' style='display:none;'>
        ...
        <param name='name' value='Airlines_17198553720830/Historia1' />
        <param name='tabs' value='no' />
        <param name='toolbar' value='yes' />
        <param name='static_image'
               value='https://public.tableau.com/static/images/Ai/Airlines_17198553720830/Historia1/1.png' />
