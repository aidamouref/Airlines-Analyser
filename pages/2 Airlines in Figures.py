...
def main():
    ...
    <div class='tableauPlaceholder' id='viz1720256591130' style='position: relative'>
        ...
        <object class='tableauViz' type='text/html' style='display:none;'>
            <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
            <param name='embed_code_version' value='3' />
            <param name='path' value='SB4CNNBDF' />
    ...
    <script type='text/javascript'>
        ...
        vizElement.style.height = (window.innerHeight - 120) + 'px';
        var scriptElement = document.createElement('script');
        scriptElement.src = 'https://public.tableau.com/javascripts/api/viz_v1.min.js';
